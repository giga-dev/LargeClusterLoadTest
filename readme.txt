...
mvn package xap:run-standalone -Dmodule=processor -Dcluster="total_members=2,1".
  ...
  Deploying the application requires starting up a Manager (or a GSM) and at least 2 GSCs (scripts located under
...
and a single instance of the mirror will be created.
  ...
  A special note regarding groups and deployment: If the Manager (or GSM) and GSCs were started under a specific
...
http://docs.gigaspaces.com/xap/12.2/started/installation-maven-overview.html
